 ...
 * @access public
 */
class WPElitePluginsUpdateChecker {
	...
	public function requestInfo($queryArgs = array()){
		...
		$queryArgs	= apply_filters( 'wpeliteplugins_modify_request_query_arguments', $queryArgs, $this->slug, $this->pluginFile );
		...
		$options = apply_filters( 'wpeliteplugins_modify_request_remote_option', $options, $this->slug, $this->pluginFile );
